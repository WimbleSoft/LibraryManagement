...
<?php
$id=$_GET['id'];
$delete = $connection->query("DELETE from kitaplar WHERE id=".$id) or die("HATA!");
$delete2 = $connection->query("DELETE from oduncler WHERE urunid='$id' and tur='Kitap'") or die("HATA!");
